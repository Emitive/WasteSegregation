...
video_detector.detectObjectsFromVideo(input_file_path=os.path.join(execution_path, "data/traffic.mp4"), output_file_path=os.path.join(execution_path, "data/result/video_second_analysis") ,  frames_per_second=20, per_second_function=forSecond,  minimum_percentage_probability=30, return_detected_frame=True, log_progress=True)